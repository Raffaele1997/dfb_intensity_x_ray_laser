...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/PbTe"
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'PbTe_planes_gain.txt')
...
plt.title('Gain estimate for different lattice planes of PbTe')
plt.savefig('PbTe/PbTe_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('PbTe/PbTe_planes_gain.csv')
