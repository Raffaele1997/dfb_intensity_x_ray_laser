...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/TiN"
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'TiN_planes_gain.txt')
...
plt.title('Gain estimate for different lattice planes of TiN')
plt.savefig('TiN/TiN_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('TiN/TiN_planes_gain.csv')
