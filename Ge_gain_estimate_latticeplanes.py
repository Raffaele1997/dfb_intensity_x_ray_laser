...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/Ge"
...
material_name = 'Ge'
a = 5.657 #Anstrom
lattice_planes = np.array([[1, 1, 1],  [2, 2, 0], [3, 1, 1], [4, 0, 0], [3, 3, 1], [4, 2, 2], [5, 1, 1]])
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'Ge_planes_gain.txt')
...
plt.title('Gain estimate for different lattice planes of Ge')
plt.savefig('Ge/Ge_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('Ge/Ge_planes_gain.csv')
