...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/GaN"
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'GaN_planes_gain.txt')
...
plt.title('Gain estimate for different lattice planes of GaN')
plt.savefig('GaN/GaN_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('GaN/GaN_planes_gain.csv')
