...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/GaP"
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'GaP_planes_gain.pdf')
...
plt.title('Gain estimate for different lattice planes of GaP')
plt.savefig('GaP/GaP_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('GaP/GaP_planes_gain.csv')
