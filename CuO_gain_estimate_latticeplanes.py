...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/CuO"
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'CuO_planes_gain.txt')
...
plt.title('Gain estimate for different lattice planes of CuO')
plt.savefig('CuO/CuO_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('CuO/CuO_planes_gain.csv')
df.to_csv('CuO/CuO_planes_gain.csv')
