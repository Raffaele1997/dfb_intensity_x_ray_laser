...
output_dir = r"/Users/raffaele/PycharmProjects/Bachelorthesis/Gain_Planes/Si"
...
# write to text file:
# Output file name
output_file_mgo = os.path.join(output_dir, 'Si_planes_gain.txt')
...
plt.title('Gain estimate for different lattice planes of Si')
plt.savefig('Si/Si_planes_gain.pdf')
plt.show()
...
#storing as csv
df.to_csv('Si/Si_planes_gain.csv')
